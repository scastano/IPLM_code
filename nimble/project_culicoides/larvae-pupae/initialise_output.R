...
(mcmcDir <- paste(format(Sys.time(), "%b%d_%Hh%M.%S"), qsubID, resL, resP, sep="_"))
...
system( paste("cp ../../larvaePupaeDataConstantsInitial.R ."))
print("larvaePupaeDataConstantsInitial.R copied to output directory")
